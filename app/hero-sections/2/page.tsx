...
const heroBanner = [
  {
    ...
    description:
      ...
      image:'https://res.cloudinary.com/dpb8r7bqq/image/upload/v1721837719/download_rdxjld.webp'
  ...
  },
  {
    ...
    description:
      ...
      image:'https://res.cloudinary.com/dpb8r7bqq/image/upload/v1721837648/features-img-1_msjovk.webp'
  ...
  },
  {
    ...
    description:
      ...
      image:'https://res.cloudinary.com/dpb8r7bqq/image/upload/v1721837633/hero-slider-1-img_iopzxw.webp'
  },
  {
    head: "Future-Driven",
          ...
          <SwiperSlide className="bg-black relative text-white" key={index}>
            ...
            <div className="absolute top-0 left-10 w-[80%] m-auto flex justify-start items-center h-full ">
              <div className="w-full sm:w-[60%] md:w-[70%] lg:w-[60%] flex flex-col gap-4">
                <span className="px-4 py-2 bg-slate-100 bg-opacity-30 w-fit rounded-md text-sm md:text-base">{item.head}</span>
                <h2 className="text-4xl sm:text-5xl lg:text-6xl xl:text-6xl">{item.title}</h2>
              </div>
            </div>
          </SwiperSlide>
        ))}
