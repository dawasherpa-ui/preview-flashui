        ...
        <div className="relative z-10 max-w-screen-xl mx-auto px-4 py-28 md:px-8">
          <div className="space-y-5 max-w-4xl mx-auto text-center">
            <h2 className="text-4xl text-white font-extrabold mx-auto md:text-5xl">
              Build website quick like a professional.
            </h2>
            ...
            >
              ...
              /> */}
              <button className="flex items-center justify-center gap-x-2 py-2.5 px-4 mt-3 w-full text-sm text-white font-medium bg-green-500 hover:bg-green-400 active:bg-green-600 duration-150 rounded-lg sm:mt-0 sm:w-auto">
                Getting started
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
