...
const Page = () => {
  ...
  const data = [
    ...
    },
    {
      ...
      Description:
        "<p>Detailed description about exploring New York City...</p>",
    },
    {
        ...
        {data.map((item: any, index: number) => (
          <Link href="javascript:void(0)" key={index}>
            <article className="group overflow-hidden rounded-2xl transition-all duration-300 transform hover:scale-105 bg-card-client border border-border">
              ...
              <div className="p-4">
                <h3 className="text-xl font-bold text-black line-clamp-2 group-hover:text-yellow-500 transition duration-300">
                  {item?.Title}
                </h3>
