        ...
        <div className="flex flex-wrap items-center justify-between rounded-lg border border-stroke bg-gray-2 px-6 py-8 dark:border-dark-3 dark:bg-dark-2 xs:px-10 md:px-8 lg:px-10">
          ...
          <div className="w-full md:w-5/12 lg:w-1/3">
            <div className="flex items-center space-x-3 md:justify-end">
              <button className="inline-flex items-center justify-center rounded-md bg-purple-500 px-7 py-3 text-center text-base font-medium text-white hover:bg-purple-800">
                Accept
              </button>
              <button className="inline-flex items-center justify-center rounded-md bg-white px-7 py-3 text-center text-base font-medium text-body-color shadow-1 hover:bg-primary hover:text-red-500 dark:bg-dark dark:text-dark-6 dark:shadow-none">
                Close
              </button>
            </div>
          </div>
