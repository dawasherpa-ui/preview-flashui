...
export default function CollapsibleBanner() {
  ...
  return (
    <>
      ...
      >
        <div className="flex w-full items-center gap-x-6 bg-purple-500 px-6 py-3 sm:px-3.5 sm:before:flex-1">
          <div className="flex items-center text-sm font-medium leading-6 text-white">
            <p>{`Get 50+ Premium Components for your next project on FlashUi`}</p>
