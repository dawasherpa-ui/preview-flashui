              ...
              <ul className="ml-auto flex gap-x-6 px-4 md:px-8 lg:max-w-3xl">
                {plans.map((item, idx) => (
                  ...
                  >
                    ...
                    <button className="px-3 py-3 rounded-lg w-full font-semibold text-sm duration-150 text-white bg-purple-600 hover:bg-purple-500 active:bg-purple-700">
                      Get Started
                    </button>
                  </li>
                ))}
                  ...
                  <tr>
                    <th className="z-20 top-12 py-6 lg:sticky">
                      <div className="flex items-center gap-x-3">
                        <div className="w-12 h-12 text-purple-600 rounded-full border flex items-center justify-center">
                          {table.label_icon}
                        </div>
